                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset('images/ph2.jpg',),
                        ) 
                      ),
                      Container(
                        margin: const EdgeInsets.fromLTRB(17, 0, 17, 10),
                        ...
                        child: const GFAccordion(
                          title: "Vaksin ternak Babi", textStyle: TextStyle(
                            color: Colors.white,
                          ),
                          collapsedIcon: Text("Detail", style: TextStyle(color: Colors.white),),
                          expandedIcon:Text("Tutup", style: TextStyle(color: Colors.white),),
                          ...
                          contentBackgroundColor: primaryClr, 
                          contentBorderRadius:BorderRadius.only(bottomLeft: Radius.circular(10),bottomRight: Radius.circular(10)),
                        ),
                      ),
                    ],
                  ),
